...
Product.create(
      ...
      :image_path => "/assets/products/1.jpg",
      :cover_path => "/assets/products/1_s.jpg",
      :cover_title => "2-3人套餐，食材心想，服务周到，交通便利",
      :sale_price => 88,
...
Product.create(
      ...
      :image_path => "/assets/products/2.jpg",
      :cover_path => "/assets/products/2_s.jpg",
      :cover_title => "轻联富润酒店：住宿1晚，美团券可叠加使用",
      :sale_price => 158,
      :original_price => 328,
      :sale_count => 1641,
